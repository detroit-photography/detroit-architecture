        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { title: 'Real Estate Photography', href: '/headshots/real-estate-portfolio', desc: 'Professional photos for property listings' },
                { title: 'Drone Photography', href: '/headshots/drone-photography', desc: 'Aerial views and elevated perspectives' },
                { title: 'Commercial Photography', href: '/headshots/branding-photography', desc: 'Marketing and branding imagery' },
              ].map((service) => (
                <Link
                  key={service.href}
                  href={service.href}
