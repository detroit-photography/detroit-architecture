...
import { Star, Check, Video, Film, Mic } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Detroit Videography Services | Professional Video Production',
  description: 'Professional videography services in Detroit. Corporate videos, promotional content, interviews & more. 5-star rated studio. Get a quote today!',
}

export default function DetroitVideographyServicesPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-detroit-green text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl mb-6">
            Detroit Videography Services
          </h1>
          
          <p className="text-xl text-detroit-cream/90 mb-8 max-w-2xl mx-auto">
            Professional video production for businesses, events, and personal projects. 
            From corporate interviews to promotional content, we bring your vision to life.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 text-center shadow-sm">
              <Video className="w-12 h-12 text-detroit-gold mx-auto mb-4" />
              <h3 className="font-display text-xl text-gray-900 mb-3">Corporate Videos</h3>
              <p className="text-gray-600">Company overviews, team introductions, and internal communications.</p>
            </div>
            <div className="bg-white p-8 text-center shadow-sm">
              <Film className="w-12 h-12 text-detroit-gold mx-auto mb-4" />
              <h3 className="font-display text-xl text-gray-900 mb-3">Promotional Content</h3>
              <p className="text-gray-600">Social media videos, product showcases, and brand stories.</p>
            </div>
            <div className="bg-white p-8 text-center shadow-sm">
              <Mic className="w-12 h-12 text-detroit-gold mx-auto mb-4" />
              <h3 className="font-display text-xl text-gray-900 mb-3">Interviews</h3>
              <p className="text-gray-600">Professional interview setups with proper lighting and audio.</p>
            </div>
          </div>
        </div>
      </section>
