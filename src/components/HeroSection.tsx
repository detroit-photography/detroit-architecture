    ...
    <div className="relative bg-detroit-green overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-24 text-center">
        <p className="text-detroit-gold uppercase tracking-[0.2em] md:tracking-[0.3em] text-xs md:text-sm mb-3 md:mb-4 font-body">
          Detroit Photography Presents
        </p>
        
        <h1 className="font-display text-4xl md:text-7xl text-white mb-4 md:mb-6 leading-tight">
          Architecture
          <span className="block text-detroit-gold italic">Repository</span>
        </h1>
        
        <p className="text-detroit-cream/80 text-base md:text-xl max-w-2xl mx-auto mb-6 md:mb-10 font-light px-4">
          A comprehensive catalog of <span className="text-white">550+ historic buildings</span> in Detroit and Southeast Michigan.
        </p>
        ...
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto px-2">
          <div className="relative">
            ...
            />
            <Search className="absolute left-3 md:left-5 top-1/2 -translate-y-1/2 w-4 md:w-5 h-4 md:h-5 text-gray-400" />
            <button
              type="submit"
